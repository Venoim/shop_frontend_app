...
var Home = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("http://localhost:3001/api/products", {
                                method: "GET",
                            })];
                    case 1:
                        response = _a.sent();
    ...
    var limitedProducts = products.slice(0, 10);
    var groupedProducts = {};
    ...
    return (<CommonLayout_1.default header={null} footer={null}>
      <div className="home-container">
        ...
        {isLoading ? (<div className="has-text-centered">
            <react_loader_spinner_1.DNA visible={true} height="80" width="80" ariaLabel="dna-loading" wrapperStyle={{}} wrapperClass="dna-wrapper"/>
          </div>) : (Object.keys(groupedProducts).map(function (category, index) { return (<div key={index}>
              <div className="product-container">
                {groupedProducts[category].map(function (product) { return (<div key={product.id} className="product-box" onClick={function () { return handleProductClick(product.id); }}>
